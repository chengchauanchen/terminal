 ...
 * @param <P>
 */
public class OrientationChangeManager<V extends IBaseView, P extends IBasePresenter<V>> {
	 ...
	 */
	static final class CacheEntry<V extends IBaseView, P extends IBasePresenter<V>> {
		P presenter;
