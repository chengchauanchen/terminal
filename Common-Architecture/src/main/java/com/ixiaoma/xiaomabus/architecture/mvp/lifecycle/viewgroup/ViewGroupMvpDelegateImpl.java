 ...
 * @param <P>
 */
public class ViewGroupMvpDelegateImpl<V extends IBaseView, P extends IBasePresenter<V>>
	...
	public ViewGroupMvpDelegateImpl(ViewGroupMvpDelegateCallback<V, P> delegateCallback) {
	...
	public void onAttachedToWindow() {
		if (delegateCallback.isRetainInstance()) {
			...
			if (presenter != null) {
				...
				presenter.attachView(delegateCallback.getUI());
				return;
			}
		}
