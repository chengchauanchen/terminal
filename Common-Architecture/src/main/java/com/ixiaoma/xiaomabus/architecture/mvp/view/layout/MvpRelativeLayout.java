 ...
 *
 */
public abstract class MvpRelativeLayout<V extends IBaseView, P extends IBasePresenter<V>>
	...
	public MvpRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr){
