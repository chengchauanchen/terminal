...
public class BadgeView extends TextView {
    ...
    public void setText(CharSequence text, BufferType type) {
        ...
        if (!TextUtils.isEmpty(text) && text.toString().equalsIgnoreCase("99+")) {
    ...
    public void setBadgeGravity(final View view, int gravity) {
        ...
        view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                logger.error("width="+width+"  paddingRight="+paddingRight);
                params.leftMargin = width == 0 ? 40 : width - (int)Math.rint(paddingRight * 1.5);
...
//            FrameLayout.LayoutParams badgeLP = new LayoutParams(10, 10);
            this.setLeft(right - 5);
            this.setTop(top + 5);
