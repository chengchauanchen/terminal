...
public class ServiceRelativeLayout extends RelativeLayout {
    public ServiceRelativeLayout(@NonNull Context context) {
        super(context);
    }

    public ServiceRelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ServiceRelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
