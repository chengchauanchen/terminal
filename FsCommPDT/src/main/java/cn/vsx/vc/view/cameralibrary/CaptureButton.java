...
import static cn.vsx.vc.view.cameralibrary.JCameraView.BUTTON_STATE_BOTH;
import static cn.vsx.vc.view.cameralibrary.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static cn.vsx.vc.view.cameralibrary.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View{
    ...
    private void startRecordAnimation(float outside_start, float outside_end, float inside_start, float inside_end) {
        ...
        animatorSet.playTogether(outside_anim, inside_anim);
