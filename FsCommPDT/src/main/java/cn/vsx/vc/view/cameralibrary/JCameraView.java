package cn.vsx.vc.view.cameralibrary;
...
import cn.vsx.vc.view.cameralibrary.listener.ReturnListener;
import cn.vsx.vc.view.cameralibrary.listener.TypeListener;
import cn.vsx.vc.view.cameralibrary.state.CameraMachine;
import cn.vsx.vc.view.cameralibrary.util.FileUtil;
import cn.vsx.vc.view.cameralibrary.util.LogUtil;
import cn.vsx.vc.view.cameralibrary.util.ScreenUtils;
import cn.vsx.vc.view.cameralibrary.view.CameraView;
...
//    private static final String TAG = "JCameraView";
    ...
    private boolean needSend;       //是否需要发送
    ...
    private void initView() {
        ...
        mCaptureLayout.setCaptureLisenter(new CaptureListener() {
            ...
            @Override
            public void recordEnd(long time,boolean needSend) {
                Log.e("JCameraView", "recordEnd");
    ...
    public void cameraHasOpened() {
        //如果是已经录制结束了，就不用重新预览
        if(videoUrl !=null && firstFrame!=null && jCameraLisenter!=null){
            return;
        }
...
//        resetState(TYPE_DEFAULT); //重置状态
        ...
        MyTerminalFactory.getSDK().registReceiveHandler(mReceiverRemoveWindowViewHandler);
...
//        resetState(TYPE_PICTURE);
        ...
        MyTerminalFactory.getSDK().unregistReceiveHandler(mReceiverRemoveWindowViewHandler);
        if(mCaptureLayout.isRecoding()){
    ...
    @Override
    public void close(){
        Log.e("JCameraView", "close"+captureBitmap+"-----"+videoUrl);
        stopVideo();
        CameraInterface.getInstance().isPreview(false);
        CameraInterface.getInstance().unregisterSensorManager(mContext);
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    @Override
    public void recordResult(Bitmap firstFrame, String url,boolean needSend){
        videoUrl = url;
        JCameraView.this.firstFrame = firstFrame;
