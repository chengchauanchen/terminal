...
public class TopRightMenu {
    ...
    private static final int DEFAULT_HEIGHT = DensityUtil.px2dip(MyApplication.instance,MyApplication.instance.getResources().getDimension(R.dimen.y400));
    private int popHeight = DEFAULT_HEIGHT;
    private int popWidth =DensityUtil.px2dip(MyApplication.instance,MyApplication.instance.getResources().getDimension(R.dimen.video_popWindow_with));
...
//        mRecyclerView.setBackgroundColor(mContext.getResources().getColor(R.color.video_pop_bg));
