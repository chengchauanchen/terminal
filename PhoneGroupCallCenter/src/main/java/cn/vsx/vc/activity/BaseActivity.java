...
//        }
    ...
    protected void protectApp() {
        ...
        Intent intent = new Intent(this, RegistGroupCallCenterActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
        ActivityCollector.removeAllActivityExcept(RegistGroupCallCenterActivity.class);
    ...
    private ReceiveTianjinAuthLoginAndLogoutHandler receiveTianjinAuthLoginAndLogoutHandler = new ReceiveTianjinAuthLoginAndLogoutHandler(){
        ...
        public void handler(boolean isLogin) {
            if(isLogin){
                //登录成功-去认证登录
                //判断是否是
                if(ActivityCollector.isActivityExist(RegistGroupCallCenterActivity.class)){
                    RegistGroupCallCenterActivity activity = ActivityCollector.getActivity(RegistGroupCallCenterActivity.class);
