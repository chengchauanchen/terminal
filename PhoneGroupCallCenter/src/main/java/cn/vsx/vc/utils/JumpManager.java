...
import static cn.vsx.hamster.common.UrlParams.JUMP_CEASE_GROUP_CALL;
import static cn.vsx.hamster.common.UrlParams.JUMP_GROUP_CALL;
import static cn.vsx.hamster.common.UrlParams.JUMP_VOIP_CALL;
...
//        GroupCallNewsActivity.startCurrentActivity(context,groupNo,group.getName(),0,"",true);
    ...
    public static void jumpToLaunch(Context context, String key, String value,String appKey){
        Intent intentLaunch = new Intent(context, RegistGroupCallCenterActivity.class);
