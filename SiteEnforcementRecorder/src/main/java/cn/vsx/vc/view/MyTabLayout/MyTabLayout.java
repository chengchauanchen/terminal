...
//    private Logger logger = Logger.getLogger(getClass());
    ...
    public final MyTabLayout.SlidingTabStrip mTabStrip;
    ...
    public static final class Tab {
        ...
        public MyTabLayout.TabView getView(){
            return mView;
        }
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        int mSelectedPosition = -1;//上一次选中的位置
...
//                logger.info("updateIndicatorPosition----left"+left+"----right:"+right);
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            final MyTabLayout.TabView targetView = (TabView) getChildAt(position);
            TextView textView = targetView.getTextView();
            if (targetView == null) {
