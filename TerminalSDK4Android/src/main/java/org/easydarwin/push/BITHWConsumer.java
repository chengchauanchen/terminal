...
import static org.easydarwin.push.BITMediaStream.info;

/**
 * Created by apple on 2017/5/13.
 */
public class BITHWConsumer extends Thread implements VideoConsumer {
    ...
    public BITHWConsumer(Context context, Pusher pusher) {
        mContext = context;
        mPusher = pusher;
    }
    ...
    public void run() {
        ...
        do {
            ...
            if (outputBufferIndex == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                synchronized (BITHWConsumer.this) {
