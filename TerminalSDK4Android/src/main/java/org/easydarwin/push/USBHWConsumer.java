 ...
 */
public class USBHWConsumer extends Thread implements USBVideoConsumer{
    ...
    public USBHWConsumer(Context context, Pusher pusher) {
        mContext = context;
        mPusher = pusher;
    }
    ...
    public int onVideo(byte[] data, int format) {
        ...
        try {
            ...
            if (UVCMediaStream.info.mColorFormat == COLOR_FormatYUV420SemiPlanar) {
                JNIUtil.yuvConvert(data, mWidth, mHeight, 6);
            } else if (UVCMediaStream.info.mColorFormat == COLOR_TI_FormatYUV420PackedSemiPlanar) {
                JNIUtil.yuvConvert(data, mWidth, mHeight, 6);
            } else if (UVCMediaStream.info.mColorFormat == COLOR_FormatYUV420Planar) {
    ...
    public void run() {
        ...
        do {
            ...
            if (outputBufferIndex == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                synchronized (USBHWConsumer.this) {
...
Video bitrate 384 Kbps 2 Mbps 4 Mbps 10 Mbps
        */
        ...
        mediaFormat.setInteger(MediaFormat.KEY_COLOR_FORMAT, UVCMediaStream.info.mColorFormat);
