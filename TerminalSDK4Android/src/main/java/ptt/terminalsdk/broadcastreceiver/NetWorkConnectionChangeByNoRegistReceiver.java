 ...
 * RuanShuo
 */
public class NetWorkConnectionChangeByNoRegistReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ConnectivityManager.CONNECTIVITY_ACTION.equals(intent.getAction())) {
            ...
            MyTerminalFactory.getSDK().getThreadPool().execute(new Runnable(){
                @Override
                public void run(){
                    MyTerminalFactory.getSDK().notifyReceiveHandler(ReceiveNetworkChangeByNoRegistHandler.class,success);
                }
            });
        }
    }
