...
public class VideoUtil {
     ...
     * @return
     */
    public static List<String> getSupportResolution(){
        List<String> resolutions=new ArrayList<>();
        String supportResolution = TerminalFactory.getSDK().getParam(Params.SUPPORT_RESOLUTION, "");
        if(!TextUtils.isEmpty(supportResolution)){
            String[] arr=supportResolution.split(";");
            if(arr.length>0){
     ...
     * @param value
     */
    public static void saveSupportResolution(String value){
        TerminalFactory.getSDK().putParam(Params.SUPPORT_RESOLUTION, value);
    }
