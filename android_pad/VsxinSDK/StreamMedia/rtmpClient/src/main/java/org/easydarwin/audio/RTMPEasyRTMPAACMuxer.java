...
import org.easydarwin.video.RTMPEasyMuxer;
 ...
 */
public class RTMPEasyRTMPAACMuxer extends RTMPEasyMuxer{
    ...
    public RTMPEasyRTMPAACMuxer(String path, boolean hasAudio, long durationMillis) {
