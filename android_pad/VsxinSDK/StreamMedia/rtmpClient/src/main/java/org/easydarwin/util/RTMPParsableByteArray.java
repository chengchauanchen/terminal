 ...
 */
public final class RTMPParsableByteArray{
   ...
   */
  public RTMPParsableByteArray(int limit) {
   ...
   */
  public RTMPParsableByteArray(byte[] data) {
    this.data = data;
    limit = data.length;
  }
   ...
   * @param limit The limit to set.
   */
  public RTMPParsableByteArray(byte[] data, int limit) {
    this.data = data;
    this.limit = limit;
  }
...
//    Assertions.checkArgument(position >= 0 && position <= limit);
   ...
   *
   * @param bitArray The {@link RTMPParsableBitArray} into which the bytes should be read.
   * @param length The number of bytes to write.
   */
  public void readBytes(RTMPParsableBitArray bitArray, int length) {
