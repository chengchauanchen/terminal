...
public class RTMPEasyMuxer{

    public static final boolean VERBOSE = true;
    private static final String TAG = RTMPEasyMuxer.class.getSimpleName();
    ...
    public RTMPEasyMuxer(String path, boolean hasAudio, long durationMillis) {
