...
public class SensorUtil {
    ...
    public static synchronized SensorUtil getInstance() {
        if (instance == null) {
            instance = new SensorUtil(PadApplication.getApplication());
        }
        return instance;
    }
    ...
    public void registSensor(){
        logger.info("个呼状态:"+PadApplication.getPadApplication().getIndividualState());
        if(!registed && null != PadApplication.getPadApplication().getIndividualState() && PadApplication.getPadApplication().getIndividualState() != IndividualCallState.IDLE){
