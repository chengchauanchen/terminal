...
public class VideoCodecExt{

    static {
        System.loadLibrary("proffmpeg");
        System.loadLibrary("VideoCodecerExt");
    }
    ...
    public static class VideoDecoderLiteExt extends VideoCodecExt{
...
//            }
        ...
        public ByteBuffer decodeFrameYUV(RTSPClient.FrameInfo aFrame, int []size) {
        ...
        public ByteBuffer decodeFrameYUV(Client.FrameInfo aFrame, int []size) {
            return decoder_decodeYUV( aFrame.buffer, aFrame.offset, aFrame.length, size);
        }
