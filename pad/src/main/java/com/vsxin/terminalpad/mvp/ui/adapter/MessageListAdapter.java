 ...
 * app模块-消息模块
 */
public class MessageListAdapter extends BaseRecycleViewAdapter<TerminalMessage, MessageListAdapter.ViewHolder>{
...
//                }
        ...
        if(TerminalMessageUtil.isGroupMessage(terminalMessage)){
            ...
            holder.iv_user_photo.setBackgroundResource(R.mipmap.img_police);
        }
