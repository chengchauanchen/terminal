...
import com.vsxin.terminalpad.receiveHandler.OnSearchListener;
...
public class GroupListFragment extends BaseFragment{
    ...
    private ArrayList<Integer> selectedMemberNos = new ArrayList<>();
...
//            memberListAdapter.notifyDataSetChanged();
        ...
        mIvSearch.setOnClickListener(v -> {
            SearchFragment.startSearchFragment(getActivity(), Constants.TYPE_CHECK_SEARCH_GROUP, selectedMemberNos,R.id.fl_layer_member_info);
        });
    }
