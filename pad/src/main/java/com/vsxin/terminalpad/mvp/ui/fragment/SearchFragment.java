...
import com.vsxin.terminalpad.mvp.ui.adapter.SearchAdapter;
...
public class SearchFragment extends BaseFragment implements BaseQuickAdapter.OnItemChildClickListener, BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener{
    ...
    public void initData(){
        ...
        searchAdapter = new SearchAdapter(mData,getActivity());
     ...
     */
    public static void startSearchFragment(FragmentActivity fragmentActivity,int type, ArrayList<Integer> selectedNos,int containerViewId){
        ...
        fragmentTransaction.add(containerViewId, searchFragment, FRAGMENT_TAG);
