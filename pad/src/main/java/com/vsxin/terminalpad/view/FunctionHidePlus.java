...
import com.vsxin.terminalpad.mvp.ui.adapter.GridViewAdapter;
import com.vsxin.terminalpad.receiveHandler.ReceiverSelectChatListHandler;
import com.vsxin.terminalpad.receiveHandler.ReceiverShowTransponPopupHandler;
...
//            }
    ...
    private void showVoiceView(boolean isGroup){
        ...
        groupCallNewsKeyboard.setBackground(getContext().getResources().getDrawable(R.drawable.soft_keyboard));
        if(isGroup){
    ...
    private void showInputView(){
        ...
        btn_record.setVisibility(View.GONE);
        btn_ptt.setVisibility(GONE);
        groupCallNewsKeyboard.setBackground(getContext().getResources().getDrawable(R.drawable.recording));
    }
