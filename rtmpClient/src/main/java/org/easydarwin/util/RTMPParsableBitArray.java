 ...
 */
public final class RTMPParsableBitArray{
   ...
   */
  public RTMPParsableBitArray(byte[] data) {
   ...
   */
  public RTMPParsableBitArray(byte[] data, int limit) {
    this.data = data;
    byteLimit = limit;
  }
